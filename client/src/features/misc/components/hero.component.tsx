...
const Hero = () => {
  return (
    <section className='overflow mb-24 h-[calc(55dvh-50px-32px)] md:h-[calc(85dvh-50px-32px)] lg:h-[calc(80dvh-50px-32px)] lg:px-6'>
      <ul className='hidden whitespace-nowrap bg-silver text-silver-dark md:flex lg:hidden'>
